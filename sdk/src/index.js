...
class ResShareClient {
  constructor(config) {
    if (!config || !config.baseUrl) {
      throw new Error('ResShareClient requires a baseUrl in config');
    }
    ...
    if (!this._fetch) {
      throw new Error('ResShareClient requires fetch (provide config.fetch in Node)');
    }
...
export { ResShareClient, ApiError };
export default ResShareClient;
